...
Java_lu_uni_jungao_bm4_NativeDelegator_sStringFromJNI(
        JNIEnv *env,
        jclass /* cls */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_lu_uni_jungao_bm4_NativeDelegator_iStringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_lu_uni_jungao_bm4_NativeDelegator_nativeSendSMS(JNIEnv *env, jobject /*this*/, jstring msg) {
    jclass MiddleCls = env->FindClass("lu/uni/jungao/bm4/MiddleCls");
...
int registerNative(JNIEnv *env){
    ...
    jclass c = env->FindClass("lu/uni/jungao/bm4/NativeDelegator");
